...
try:
    from app.agents.high.config import MAX_COMPLAINT_TEXT_LENGTH, MIN_COMPLAINT_TEXT_LENGTH
except ImportError:
    try:
        from config import MAX_COMPLAINT_TEXT_LENGTH, MIN_COMPLAINT_TEXT_LENGTH
    except ImportError:
