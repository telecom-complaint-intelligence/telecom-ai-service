...
from agents.high.retrieval.qdrant_retriever import high_agent_retriever

DATA_PATH = Path(__file__).resolve().parent.parent / "data" / "complaints.json"
...
def load_historical_complaints() -> List[Dict[str, Any]]:
    ...
    -------
    List[Dict[str, Any]]
        List of historical complaint records.
    """
    ...
    try:
        ...
        print(f"⚠️ Error loading historical complaints: {e}")
        return []
